...
const translations = {
  ...
  giftPreferenceNote: "Your presence is the greatest gift. Should you wish to give us something, we kindly prefer a monetary gift in place of physical presents.",
    rsvpButton: "RSVP now",
  ...
  th: {
    ...
    heroYear: "\u0e1e.\u0e28. 2569",
    savebarTitle: "โปรดบันทึกวันสำคัญนี้ไว้",
    ...
    welcomeReception: "งานเลี้ยงต้อนรับ",
...
Object.assign(translations.en, {
  ...
  plusOneName: "Your plus-one's name (use a nickname if they are Thai)",
...
Object.assign(translations.th, {
  ...
  storyTitle: "ทุกบทของเรื่องราว พาเราให้ใกล้กันยิ่งขึ้น",
  guestName: "ชื่อเล่นของคุณ (ไม่ต้องใส่ชื่อ-นามสกุล)",
  ...
  plusOneName: "ชื่อเล่นของผู้ติดตาม (ไม่ต้องใส่ชื่อ-นามสกุล)",
  optionalPlaceholder: "ไม่บังคับ",
  dietaryNeeds: "ข้อจำกัดด้านอาหารหรืออาหารที่แพ้",
  dietaryPlaceholder: "โปรดแจ้งรายละเอียดที่เราควรทราบ",
  ...
  letterNote: "ด้วยรักจากเราทั้งสอง",
...
Object.assign(translations.th, {
  ...
  photoTitle: "จับมือกัน ก้าวไปด้วยกันตลอดไป",
  storyEyebrow: "ทุกช่วงเวลาที่พาเรามาถึงวันนี้",
  storyTitle: "ทุกบทของเรื่องราว พาเราให้ใกล้กันยิ่งขึ้น",
  heroEyebrow: "พร้อมด้วยครอบครัวของเราทั้งสองฝ่าย",
  heroInvite: "มีความยินดีขอเรียนเชิญท่านร่วมเป็นสักขีพยานในพิธีมงคลสมรสของ",
  celebrateEyebrow: "ร่วมฉลองความรักของเรา",
  celebrateTitle: "เรากำลังจะแต่งงานกัน",
  celebrateCopy: "เราจะยินดีอย่างยิ่งที่ได้มีคุณอยู่เคียงข้าง ในวันที่เราเริ่มต้นบทใหม่ของชีวิต มาร่วมเป็นสักขีพยานในคำมั่นสัญญาของเรา ร่วมรับประทานอาหาร และเฉลิมฉลองช่วงเวลาพิเศษนี้ไปด้วยกัน",
  scheduleEyebrow: "กำหนดการในวันสำคัญของเรา",
  programNote: "เรายินดีอย่างยิ่งที่จะได้แบ่งปัน<br>ทุกช่วงเวลาสำคัญนี้กับคุณ",
  venueEyebrow: "สถานที่สำหรับวันสำคัญของเรา",
  venueTitle: "สถานที่จัดงาน",
  venueCopy: "แตะด้านล่างเพื่อดูสถานที่<br>และเส้นทางบน Google Maps",
  countdownEyebrow: "นับถอยหลังสู่วันสำคัญของเรา",
  countdownTitle: "อีกไม่นาน เราจะเริ่มต้นคำว่า “ตลอดไป” ไปด้วยกัน",
  rsvpEyebrow: "กรุณาตอบรับ",
  rsvpTitle: "มาร่วมฉลองวันสำคัญกับเราไหม",
  rsvpCopy: "โปรดแจ้งให้เราทราบว่าคุณจะมาร่วมวันสำคัญของเราได้หรือไม่",
  giftPreferenceNote: "การมาร่วมงานของคุณคือของขวัญที่มีค่าที่สุดสำหรับเรา หากประสงค์จะมอบของขวัญ ขออนุญาตรับเป็นเงินแทนของขวัญหรือสิ่งของ",
  rsvpNote: "กรุณาตอบรับภายในวันที่ 30 กันยายน พ.ศ. 2569",
  ...
  scrollExplore: "เลื่อนลงเพื่อร่วมเดินทางไปกับเรื่องราวของเรา",
});
...
Object.assign(translations.my, {
  ...
  giftPreferenceNote: "မင်္ဂလာပွဲသို့ လာရောက်ပေးခြင်းကပင် ကျွန်ုပ်တို့အတွက် အဖိုးတန်ဆုံးလက်ဆောင်ဖြစ်ပါသည်။ မင်္ဂလာလက်ဖွဲ့ပေးလိုပါက ပစ္စည်းလက်ဆောင်များအစား ငွေသားဖြင့်သာ ချီးမြှင့်ပေးပါရန် မေတ္တာရပ်ခံအပ်ပါသည်။",
